...
class Annonce
{
     ...
     * @var integer
     *
     * @ORM\ManyToOne(targetEntity="Site\TourneurFraiseurBundle\Entity\Recruteur")
	 * @ORM\JoinColumn(nullable=false)
     */
    private $idRecruteur;
     ...
     * Add site
     *
     * @param \Site\TourneurFraiseurBundle\Entity\Annonce_Sy_Siteemploi $site
     *
     * @return Annonce
     */
    public function addSite(\Site\TourneurFraiseurBundle\Entity\Annonce_Sy_Siteemploi $site)
    {
        $this->site[] = $site;
	...
	*/
     ...
     * Set idRecruteur
     *
     * @param \Site\TourneurFraiseurBundle\Entity\Recruteur $idRecruteur
     *
     * @return Annonce
     */
    public function setIdRecruteur(\Site\TourneurFraiseurBundle\Entity\Recruteur $idRecruteur)
    {
     ...
     * Get idRecruteur
     *
     * @return \Site\TourneurFraiseurBundle\Entity\Recruteur
     */
     ...
     * @param \Site\TourneurFraiseurBundle\Entity\Annonce_Sy_Siteemploi $site
     */
    public function removeSite(\Site\TourneurFraiseurBundle\Entity\Annonce_Sy_Siteemploi $site)
    {
     ...
     * Add fonction
     *
     * @param \Site\TourneurFraiseurBundle\Entity\Annonce_Sy_Siteemploi $fonction
     *
     * @return Annonce
     */
    public function addFonction(\Site\TourneurFraiseurBundle\Entity\Annonce_Sy_Siteemploi $fonction)
    {
     ...
     * @param \Site\TourneurFraiseurBundle\Entity\Annonce_Sy_Siteemploi $fonction
     */
    public function removeFonction(\Site\TourneurFraiseurBundle\Entity\Annonce_Sy_Siteemploi $fonction)
    {
